...
## 8. v3.6 变更摘要(2026-09,进化传播链 + 数据裁判)
...
## 8. v3.4 变更摘要(2026-09,泛化鲁棒性 + 诚实化 + 可发现性)
...
## 10. v3.1 变更摘要(2026-08,观察期测量 + 循环抑制退避)
...
## 11. v3.0 变更摘要(2026-08,运行态实证 + 稳定版)
...
## 12. v2.9 变更摘要(2026-08,AI 模式/自学习专项)
