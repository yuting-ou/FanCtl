...
## 8. v3.7 变更摘要(2026-09,信任三角:学习地图+冻结曲线+决策透镜)
...
## 9. v3.6.3 变更摘要(2026-09,动态方法论审查:模糊+变异+消毒器)
...
## 10. v3.6.2 变更摘要(2026-09,第一性原理发散审查收尾)
...
## 11. v3.6.1 变更摘要(2026-09,对抗式审查稳定版)
...
## 12. v3.6 变更摘要(2026-09,进化传播链 + 数据裁判)
...
## 13. v3.4 变更摘要(2026-09,泛化鲁棒性 + 诚实化 + 可发现性)
...
## 16. v3.1 变更摘要(2026-08,观察期测量 + 循环抑制退避)
...
## 17. v3.0 变更摘要(2026-08,运行态实证 + 稳定版)
...
## 18. v2.9 变更摘要(2026-08,AI 模式/自学习专项)
