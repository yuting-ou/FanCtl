...
**版本**:3.2 (build 48) · **语言**:Swift 5.9 · **平台**:macOS 26+ (Apple Silicon / Intel) · **无第三方依赖**
...
## 9. v3.1 变更摘要(2026-08,观察期测量 + 循环抑制退避)
...
## 10. v3.0 变更摘要(2026-08,运行态实证 + 稳定版)
...
## 11. v2.9 变更摘要(2026-08,AI 模式/自学习专项)
