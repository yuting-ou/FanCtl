...
// 两源同值由 scripts/test-root-scripts.sh 钉住（R54）。抬升记录：4995=R53 实测 5006/91 组；5005=R54 实测 5016/91 组；5025=R55 实测 5040/92 组；5045=R56 实测 5076/93 组
