...
// 两源同值由 scripts/test-root-scripts.sh 钉住（R54）。抬升记录：4995=R53 实测 5006/91 组；5005=R54 实测 5016/91 组；5025=R55 实测 5040/92 组；5045=R56 实测 5076/93 组；5070=R57 实测 5098/94 组；5080=R60 实测 5102/95 组；5090=R61 实测 5106/95 组；5100=R62 实测 5110/95 组；5105=R63 实测 5111/95 组
